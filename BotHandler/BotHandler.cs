...
namespace BotHandler
{
    ...
    public class Bot
    {
      ...
      //  public static string busdcontrac = "0x7ef95a0fee0dd31b22626fa2e10ee6a223f8a684";
        ...
        private Data _dataUser;


        public Bot(ref Data  data, IConsole controller)
        {
            _dataUser = data;
            _console = controller;
        ...
        public async Task<decimal> GetAccountBalance()
        {
            ...
            var web3 = new Web3(bscNode);
            var balance = await web3.Eth.GetBalance.SendRequestAsync(_dataUser.wallet);
        ...
        public  async Task<TxResult> DeBNBaToken(string cantidad, decimal minimo, List<string> tokens, string gas)
        {
            try
            {
                ...
                var account = new Account(_dataUser.privateKey, CurrentChain);
        ...
        public async Task<decimal> TokenBalanceAsync(string token)
        {
            ...
            try
            {
                ...
                var decimals = await contract4.GetFunction("decimals").CallAsync<int>();
                var balance4 = await balanceFunction.CallAsync<BigInteger>(_dataUser.wallet);
                return Web3.Convert
                    .FromWei(
                        balance4, decimals);
            }
